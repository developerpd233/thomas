...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        // mohit
        $this->app->bind(\App\Repositories\SubMaterialGroupRepository::class, \App\Repositories\SubMaterialGroupRepositoryEloquent::class);
         // 
        ...
        $this->app->bind(\App\Repositories\SubscriberTreeHistoryRepository::class, \App\Repositories\SubscriberTreeHistoryRepositoryEloquent::class);
        //:end-bindings:
    }
}
