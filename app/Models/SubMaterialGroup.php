...
class SubMaterialGroup extends Model implements Transformable

{
    ...
    protected $table = 'sub_material_group';
    ...
    protected $fillable = [
        ...
        'group_id', 'title', 'slug', 'price','group_thumbnail_url', 'payment_type', 'enable_payment_button', 'paypal_plan_id'
    ...
    public function SubmaterialGroups()

    {

        return $this->belongsTo('App\Models\SubMaterialGroup','sub_material_group_id','id');
