...
class SubscriberTreeHistory extends Authenticatable {
     ...
     */
    protected $table = 'subscriber_tree_history';
     ...
     */
    protected $fillable = [
        'id', 'parent_id', 'first_name', 'last_name', 'subscriber_commision', 'is_admin',
        'is_active', 'created_at', 'history_saved_at'
    ];
