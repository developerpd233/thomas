...
<div class="ibox float-e-margins">
    <div class="ibox-content">
        <?php echo Form::open(array('id' => 'update-code', 'method' => 'put', 'files' => false,'class'=>'form-horizontal')); ?>
            ...
            <div class="form-group required">
                ...
                <div class="col-md-6">
                    ...
                    <?php echo Form::text('code', $code->code, ['id'=>'code', 'class'=>'form-control']); ?>
