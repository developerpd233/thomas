<?php $__env->startSection('page_title'); ?>
    <?php echo e(trans('Reset Password')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <div class="formContainer">
        <h3 class="">Changed Users Password Here</h3>
        <form action="<?php echo e(route("admin.user.changePassword",["post"=>$id])); ?>" method="POST" onsubmit="return validate()">
                ...
                <div class="form-group row">
                    <div class="col-lg-4">
                        <input type="email" class="form-control" name="email" id="exampleInputEmail1"
                               aria-describedby="emailHelp" value="<?php echo e($getUser->email); ?>" readonly="readonly"
