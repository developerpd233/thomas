<?php $__env->startSection('page_title'); ?>
    <?php echo e(trans('Edit Material Level')); ?>
    ...
    <div class="ibox-content">
        <?php echo Form::open(array('method' => 'put', 'files' => true,'class'=>'form-horizontal')); ?>
            ...
            <div class="form-group required">
                ...
                <div class="col-md-6">
                    <?php echo Form::selectGroup('group_id', old('group_id', $materialSubGroup->group_id), ['id'=>'group_id', 'class'=>'form-control']); ?>
            ...
            <div class="form-group required">
                ...
                <div class="col-md-6">
                    <?php echo Form::text('title', old('title', $materialSubGroup->title), ['id'=>'title', 'class'=>'form-control']); ?>
            ...
            <div class="form-group required">
                ...
                <div class="col-md-6">
                    <?php echo Form::text('slug', old('slug', $materialSubGroup->slug), ['id'=>'slug', 'class'=>'form-control']); ?>                    
                </div>
            </div>
            ...
            <div class="form-group required">
                ...
                <div class="col-md-6">
                    <?php echo Form::text('price', old('price', $materialSubGroup->price), ['id'=>'price', 'class'=>'form-control']); ?>                    
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <?php echo Form::checkbox('enable_payment_button', 'YES', ($materialSubGroup->enable_payment_button=='YES' ? true:false)); ?>
