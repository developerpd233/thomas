            ...
            <ul class="list-inline">
                ...
                <li class="pull-right">
                    ...
                    <!--<li>
                        ...
                        <li><a href="#"><i class="livicon" data-name="login" data-size="18" data-loop="true" data-c="#fff" data-hc="#fff"></i></a><label class="hidden-xs"><a href="<?php echo e(url('/locale/en')); ?>" class="text-white"><?php echo e(trans('English')); ?></a></label></li>
                        <li><a href="#"><i class="livicon" data-name="login" data-size="18" data-loop="true" data-c="#fff" data-hc="#fff"></i></a><label class="hidden-xs"><a href="<?php echo e(url('/locale/fr')); ?>" class="text-white"><?php echo e(trans('French')); ?></a></label></li>
                        <?php if(Auth::guest()): ?>
                            <li><a href="#"><i class="livicon" data-name="login" data-size="18" data-loop="true" data-c="#fff" data-hc="#fff"></i></a><label class="hidden-xs"><a href="<?php echo e(url('/login')); ?>" class="text-white"><?php echo e(trans('frontend.login')); ?></a></label></li>
                            <li><a href="#"><i class="livicon" data-name="register" data-size="18" data-loop="true" data-c="#fff" data-hc="#fff"></i></a><label class="hidden-xs"><a href="<?php echo e(url('/register/2')); ?>" class="text-white"><?php echo e(trans('frontend.register')); ?></a></label></li>
                        <?php else: ?>
                            <li>
                                ...
                                <ul class="nav" id="account-nav">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo e(url('user/'.Auth::user()->username)); ?>"><i class="glyphicon glyphicon-user"></i>Profile</a></li>
                                            <li><a href="<?php echo e(route('user.account')); ?>"><i class="glyphicon glyphicon-cog"></i>Account Settings</a></li>
                                            <li>
