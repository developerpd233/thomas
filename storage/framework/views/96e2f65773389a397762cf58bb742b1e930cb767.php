    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo Form::open(array('id' => 'compose-message', 'route' => 'message.send', 'method' => 'post', 'files' => false,'class'=>'form-horizontal')); ?>


                    <div class="form-group required">
                        <div class="col-md-4">
                            <?php echo Form::label('to_username', trans('To'), ['class' => 'control-label']); ?>

                        </div>
                        <div class="col-md-6">
                            <?php echo Form::text('to_username', old('to_username', (!empty($toUsername)) ? $toUsername : ''), ['id'=>'to_username', 'class'=>'form-control']); ?>
