...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" style="margin-bottom: 15px;">
            ...
            <li class=""><a href="#account" data-toggle="tab"><?php echo e(trans('user.account_info')); ?></a></li>
            ...
            <li class="active "><a href="#subscription" data-toggle="tab"><?php echo e(trans('user.subscription')); ?></a></li>
