                ...
                <div class="thumbnail">
                    <div class="caption">
                        <?php if($materialGrp->price > 0.00): ?>
                            <h4 class="pull-right text-success">$<?php echo e($materialGrp->price); ?></h4>
                        <?php endif; ?>
                        <h4>
                            <a href="<?php echo url('user-academy/viewGroup/' . $materialGrp->id); ?>"><?php echo e($materialGrp->title); ?></a>
                        </h4>
                        <hr>
                    </div>
                    <a href="<?php echo url('user-academy/courseGroup/' . $materialGrp->id); ?>">
