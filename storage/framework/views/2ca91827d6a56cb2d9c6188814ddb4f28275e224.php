...
<?php $__env->startSection('page_title'); ?>
    <?php echo e(trans('Add  Sub Material Group')); ?>
...
<div class="ibox float-e-margins">
    <div class="ibox-content">
        <?php echo Form::open(array('route' => 'admin.sub-material-group.add', 'method' => 'post', 'files' => false,'class'=>'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
