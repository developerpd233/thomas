<?php
// dd(Session::get('flash-message-french'));
return [
    'dashboard' => 'Tableau de bord',
    'profile' => 'Profil',
    'account' => 'Paramètres du compte',
    'tree' => 'Arbre des abonnés de l\'utilisateur',


    // Group
    'title' => 'Titre',
    'material_type' => 'type de materiau',
    'material_group' => 'Groupe de matériaux',
    'material_level' => 'Niveau de matériau',
    ...
    // Navigation
    'home' => 'Accueil',
    'my_academy' => 'Les Cours',
    'video' => 'Videos',
    'course' => 'Cours',
    'company_profile' => 'Visitez votre page',
    // .... rest of the code

    'not_active' => 'Votre compte est bloqué en raison du non-paiement des frais d\'abonnement! Pour rouvrir votre compte, payez vos frais d\'abonnement!',
    'ban' => 'Votre compte est banni de DNAsbook Digital Marketing (DDM). Pour toute question, contactez Admin sur WhatSapp au 1 908 249 7637 (USA) !',
    ...
    'new-flash-message'=>'Nos frais mensuels sont $50.',
    'new-Subscription-fee'=> '$50.',
	...
	'new_combine_message' => 'Vous devez payer vos frais avant le 30 de chaque mois pour garder votre compte ouvert et vos commissions payées. Nos frais mensuels sont de $50. Pour savoir comment payer vos frais, ',
    'please' => ', s\'il vous plaît!',

    //flash message for offline-payment
    'offline_payment_verify_message' => "Contactez l'administrateur sur Whatsapp pour votre paiement (+1 908 249 7637) avec votre nom, votre numéro d'identification (le numéro à la fin de votre lien d'affiliation) et la preuve de votre paiement (reçu ou capture d'écran de votre paiement).",
    ...
    'flash_of_payment_register' => 'Paiement effectué avec succès',
    'cancel_subscription_msg' => 'Vous pouvez annuler votre abonnement depuis votre compte PayPal'
];
