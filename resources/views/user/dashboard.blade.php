...
<div class="panel panel-default">
    ...
    @if(Auth::user()->not_now == 1)
        <div class="alert alert-info" role="alert">
            <b class="text-danger">Important</b>: {{ trans('app.new_combine_message') }}
            <a href="/pages/how-to-pay-in-opportunity-4" style="font-weight:bold;color:blue">
                {{ trans('app.click_here') }}</a>{{ trans('app.please') }}
                <br>
                <br>
            <!--@if(env('SITE') == 'ENG')
                @if(App::getLocale() == 'fr')
    ...
    <div class="row">
        <div class="col-lg-5">
            <input type="text" id="myInput" class="form-control"
                value="{{ asset('/register').'/'.$user }}" id="inputDefault"
                readonly>
        </div>
        <div class="col-lg-1">
...
<div class="fb-share-button" data-href="{{ asset('/register').'/'.$user }}"
...
<a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-size="large"
    data-url="{{ asset('/register').'/'.$user }}" data-related="asdf"
    data-show-count="false">Tweet</a>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
<div class="g-plus" data-action="share" data-height="24"
    data-href="{{ asset('/register').'/'.$user }}"></div>
<br>
