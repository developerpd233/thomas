            ...
            <div id="myTabContent" class="tab-content"> <!--class="tab-content"-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="livicon" data-name="upload-alt" data-size="20"
                                                           ...
                                                           data-hc="white"></i>{{ trans('user.upload_profile_photo') }}
                                </h3>
                            </div>
                            <div class="panel-body" style="padding:0px !important;">

                                <div style="width:150px; margin: 0 auto;padding-top:2px">
                                    <img src="{{ asset($user->photo) }}" id="avatarProfileImage" width="150px"
                ...
                <div class="tab-pane fade" id="social">
                    ...
                    <div class="form-group">
                        ...
                        <p class="sub">{{ trans('user.this_url') }}
                            <strong>{{ trans('user.optional') }}</strong> {{ trans('user.will_appear_in_funnels') }}</p>
                ...
                <p class="">{{__('subscription.Warning')}}</p>
