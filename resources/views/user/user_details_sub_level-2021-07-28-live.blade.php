        ...
        <tr>
            ...
            <td style="font-size: 2rem">
                ...
                if ($countNewRegistrations >= 2) {
                    if (((int) $parent['0']->subscriber_commision) == ($countNewRegistrations * 25) || $countNewRegistrations >= 2) {
                        echo '&#9989';
                    } else {
                        echo '&#x274C';
                    }
            ...
            <td style="font-size: 2rem">
                ...
                <?php
                if ($countNewRegistrations >= 2) {
                    if (((int) $parent['0']->subscriber_commision) == ($countNewRegistrations * 25)) {
                        echo $amount;
                    } else {
                        echo 'Not Paid';
                    }
            ...
            <td style="font-size: 2rem">
                ...
                <?php                    
                    /*if ($countNewRegistrations >= 1) {
                        echo '$' . ((int) $parent['0']->subscriber_commision);
                    } else {
                        echo '0';
                    }*/
                ...
                <?php
                    if ($countNewRegistrations >= 1) {
                        echo (((int) $parent['0']->subscriber_commision / 25) * 500) . 'F';
                    } else {
                        echo '0';
                    }
                ?>
