    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            ...
            <div class="form-group required">
                ...
                <div class="col-md-6">
                    {!! Form::text('price', $containerAcademy->price, ['id'=>'slug', 'class'=>'form-control']) !!}
                </div>
            </div>
            ...
            <div class="form-group required">
                ...
                <div class="col-md-6">
                    {!! Form::selectPaymentType('payment_type', $containerAcademy->payment_type, ['class'=>'form-control']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    {!! Form::checkbox('enable_payment_button', 'YES', ($containerAcademy->enable_payment_button=='YES' ? true:false)) !!}
                </div>
            </div>
